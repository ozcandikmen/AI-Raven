...
source.include_exts = py,png,gif,jpg,kv,atlas,wav,zip
...
requirements = kivy, plyer, jnius, android
...
presplash.filename = files/presplash.jpg

# (str) Icon of the application
icon.filename = files/icon.png
